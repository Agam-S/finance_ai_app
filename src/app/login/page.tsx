        ...
        <div className="p-8">
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">
              Sign in to <span className="text-indigo-600 dark:text-indigo-400">FinanceAI</span>
            </h2>
          ...
          <motion.form variants={itemVariants} onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <div>
              <label htmlFor="password" className="flex justify-between text-sm font-medium">
                ...
                <Link href="/forgot-password" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">
                  Forgot password?
                </Link>
              </label>
              <div className="mt-1">
